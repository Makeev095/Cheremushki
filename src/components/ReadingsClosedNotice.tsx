export function ReadingsClosedNotice() {
  return (
    <div
      className="relative overflow-hidden rounded-2xl border border-amber-200/90 bg-gradient-to-br from-amber-50 via-white to-amber-50/80 p-4 shadow-md ring-1 ring-amber-900/10 sm:p-8"
      role="alert"
    >
