      ...
      <div className="relative flex gap-4">
        ...
        <div className="min-w-0 space-y-4">
          ...
          <p className="text-sm leading-relaxed text-amber-900/85">
            Приём показаний на сайте открыт в эти дни (по московскому времени).
            Если у вас срочный вопрос по счётчикам, свяжитесь с офисом УК или
            аварийной службой — контакты на главной странице.
          </p>
        </div>
      </div>
    </div>
